...
import { Image, Text, Button, Table, Thead, Tbody, Tr, Th, Td, Input, Divider } from '@chakra-ui/react'
...
function MyNft({lockData}) {
	...
	return (
        <div className={styles.cardContainer}>
            {lockData && lockData.map((item) => {
                return (
                    <div className={styles.card}>
                        <Image className={styles.cardImage} src={item.lockImage} />
                        <br/>
                        <Table size='sm'>
                            <Thead>
                                <Tr>
